        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-5 mb-12">
            {privacySections.map((section) => (
              <div
                key={section.id}
                className="bg-white border border-[#e8e0d0] rounded-sm p-6 border-l-4 border-l-[#7a1b38]"
              >
          ...
          <div className="bg-[#f7f0e8] rounded-sm p-6 text-center border border-[#d4af37]/20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center justify-center h-11 px-6 border-2 border-[#7a1b38]/30 text-[#7a1b38] text-sm font-semibold rounded-sm hover:bg-[#7a1b38]/5 hover:border-[#7a1b38] transition-all"
              >
                {BUSINESS.EMAIL}
              </a>
            </div>
          ...
          <div className="flex items-center justify-center gap-6 text-xs text-muted-foreground pt-8">
            <Link href="/terms" className="hover:text-[#7a1b38] transition-colors font-medium">
              Terms & Conditions
            </Link>
