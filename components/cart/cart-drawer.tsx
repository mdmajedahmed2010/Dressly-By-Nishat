      ...
      >
        ...
        {items.length === 0 ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-6 text-center py-10">
            ...
            <button
              onClick={closeCart}
              className="inline-flex items-center justify-center h-11 px-8 border border-[#7a1b38] bg-transparent text-[#7a1b38] text-xs font-bold uppercase tracking-wider hover:bg-[#7a1b38] hover:text-[#d4af37] transition-all duration-300 cursor-pointer rounded-sm"
            >
              Start Shopping
            </button>
          </div>
                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="h-9 px-4 bg-[#7a1b38] text-[#d4af37] text-[10px] font-bold uppercase tracking-[0.15em] hover:bg-[#4a0516] transition-all disabled:opacity-50 cursor-pointer whitespace-nowrap rounded-r-sm shrink-0"
                    >
            ...
            <div className="pt-2 space-y-4">
              ...
              <div className="space-y-2 mt-4">
                ...
                <Link
                  href="/checkout"
                  onClick={closeCart}
                  className="relative flex items-center justify-center w-full h-12 bg-[#7a1b38] text-[#d4af37] font-bold text-xs uppercase tracking-[0.2em] hover:bg-[#4a0516] transition-all duration-300 overflow-hidden group/checkout rounded-sm shadow-sm"
                >
