              ...
              <div className="container mx-auto px-5 sm:px-8 md:px-12 lg:px-16">
                ...
                >
                  ...
                  <div className="flex items-center gap-2.5 sm:gap-3 mb-3 sm:mb-5">
                    ...
                    />
                    <span
                      className={`inline-block px-3 py-0.5 sm:py-1 rounded-full border border-[#d4af37]/50 bg-[#7a1b38]/60 backdrop-blur-md text-[#d4af37] text-[9.5px] sm:text-xs uppercase tracking-[0.22em] sm:tracking-[0.28em] font-bold transition-all duration-700 delay-500 shadow-sm ${
                        isActive && heroReady
                  ...
                  >
                    <Link
                      href={slide.link}
                      className="relative inline-flex items-center justify-center gap-2 sm:gap-2.5 h-11 sm:h-13 md:h-14 px-6 sm:px-9 bg-[#7a1b38] hover:bg-[#5c132a] text-[#d4af37] text-[11px] sm:text-xs font-bold uppercase tracking-[0.16em] sm:tracking-[0.2em] transition-all duration-300 rounded-sm shadow-luxury hover:shadow-gold-glow active:scale-[0.98] group/btn cursor-pointer border border-[#d4af37]/40 overflow-hidden"
                    >
                      {/* CTA shimmer overlay */}
