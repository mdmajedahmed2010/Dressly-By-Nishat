    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-6 text-center max-w-md mx-auto animate-scale-in">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center h-12 px-8 bg-[#7a1b38] hover:bg-[#4a0516] text-[#d4af37] text-xs font-bold uppercase tracking-widest transition-all duration-300 rounded-sm active:scale-95 shadow-md"
        >
          Start Shopping
        </Link>
      </div>
      ...
      <div className="max-w-2xl mx-auto text-center py-12 px-6 space-y-7 border border-[#d4af37]/30 bg-[#fdfaf5] shadow-[0_12px_40px_rgba(0,0,0,0.03)] rounded-lg animate-scale-in">
        ...
        <div className="p-5 bg-white border border-[#e8e0d0] rounded-lg max-w-md mx-auto space-y-4 shadow-sm">
          ...
          <div className="flex justify-between items-center text-xs">
            ...
            <span className="font-bold text-[#7a1b38] text-sm">{formatPrice(confirmedTotal)}</span>
          </div>
        </div>
        ...
        <div className="pt-4 max-w-md mx-auto space-y-3">
          <Link
            href="/track-order"
            className="flex items-center justify-center w-full h-12 bg-[#7a1b38] text-[#d4af37] text-xs font-bold uppercase tracking-[0.2em] hover:bg-[#4a0516] transition-all duration-300 rounded-sm active:scale-95 shadow-md"
          >
            Track Order Status
          </Link>
          <Link
            href="/"
            className="flex items-center justify-center w-full h-11 border border-[#7a1b38]/30 bg-white text-[#7a1b38] hover:bg-[#7a1b38]/5 text-xs font-bold uppercase tracking-[0.15em] transition-all duration-300 rounded-sm"
          >
            Continue Shopping
          </Link>
        </div>
              ...
              <div className="space-y-3.5">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="h-10 px-4 bg-[#7a1b38] hover:bg-[#4a0516] text-[#d4af37] text-[10px] font-bold uppercase tracking-[0.15em] transition-all disabled:opacity-50 cursor-pointer whitespace-nowrap rounded-sm shadow-sm"
                  >
